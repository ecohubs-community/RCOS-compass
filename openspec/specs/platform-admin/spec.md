...
## Purpose
Describes the operator-facing admin console: who may reach it, the boundary that keeps platform admins out of community content, how tenants are created by inviting an owner, and how destructive actions stay deliberate, reversible and audited.
## Requirements
