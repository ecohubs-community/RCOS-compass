# self-audit Specification

## Purpose
Covers the recorded act that fixes what was true on a date: an immutable snapshot of compliance, missing artifacts, uncovered clauses, provisional definitions, stale reviews, decisions frozen over objections, live exceptions and readiness per layer — computed from records alone, changing nothing, accumulating rather than being edited, and cited by date on the public index.
## Requirements
