...
## Purpose
Covers the two numbers a community sees: readiness as the proportion of answerable MUST clauses satisfied, computed from current rows on every read and reported per layer as well as overall, and compliance as a binary claim over the mandatory artifacts of the core standard.
## Requirements
