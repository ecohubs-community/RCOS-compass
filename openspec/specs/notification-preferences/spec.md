...
## Purpose
What a member receives by email from each community they belong to: whether email is on, which day their digest arrives in their own time zone, and a way to change it from every email.
## Requirements
